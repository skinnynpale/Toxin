...
const values = document.querySelectorAll('.find-room .dropdown__value');
const funcBtns = document.querySelectorAll('.dropdown__func-btn');
const primeItem = document.getElementById('guestsDropPrimeItemValue'); // Младенцы
